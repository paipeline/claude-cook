...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn cook-planner agent, verify plans with cook-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/cook:new-project` first.
...
| cook-plan-checker | sonnet | sonnet | haiku |
...
## 8. Spawn cook-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 COOK ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<downstream_consumer>
Output consumed by /cook:execute-phase
...
```
Task(
  prompt="First, read ~/.claude/agents/cook-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
## 10. Spawn cook-plan-checker Agent

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 COOK ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Task(
  ...
  subagent_type="cook-plan-checker",
  model="{checker_model}",
...
Spawn cook-planner with revision prompt:
...
- /cook:plan-phase {X} --research — re-research first
...
- [ ] cook-phase-researcher spawned if research needed
- [ ] Existing plans checked
- [ ] cook-planner spawned with context (including RESEARCH.md if available)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] cook-plan-checker spawned (unless --skip-verify)
