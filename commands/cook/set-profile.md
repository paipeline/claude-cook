---
name: set-profile
description: Switch model profile for COOK agents (quality/balanced/budget)
arguments:
  - name: profile
...
<objective>
Switch the model profile used by COOK agents. This controls which Claude model each agent uses, balancing quality vs token spend.
</objective>
...
```
Error: No COOK project found.
Run /cook:new-project first to initialize a project.
```
