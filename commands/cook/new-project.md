...
1. **Abort if project exists:**
   ```bash
   [ -f .planning/PROJECT.md ] && echo "ERROR: Project already initialized. Use /cook:progress" && exit 1
   ```
...
- options:
  - "Map codebase first" — Run /cook:map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/cook:map-codebase` first, then return to `/cook:new-project`
```
Exit command.
...
**Note:** Run `/cook:settings` anytime to update these preferences.
...
Spawn 4 parallel cook-project-researcher agents with rich context:

```
Task(prompt="First, read ~/.claude/agents/cook-project-researcher.md for your role and instructions.
...
- [ ] cook-roadmapper spawned with context
