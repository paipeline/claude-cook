...
**After this command:** Run `/cook:plan-phase [N]` to start execution.
</objective>

<execution_context>
@~/.claude/cook/references/questioning.md
@~/.claude/cook/references/ui-brand.md
@~/.claude/cook/templates/project.md
@~/.claude/cook/templates/requirements.md
</execution_context>
...
**Load milestone context (if exists, from /cook:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /cook:discuss-milestone)
...
|-------|---------|----------|--------|
| cook-project-researcher | opus | sonnet | haiku |
| cook-research-synthesizer | sonnet | sonnet | haiku |
| cook-roadmapper | opus | sonnet | sonnet |
...
Spawn 4 parallel cook-project-researcher agents with milestone-aware context:
...
Use template: ~/.claude/cook/templates/research-project/STACK.md
</output>
", subagent_type="cook-project-researcher", model="{researcher_model}", description="Stack research")
...
Use template: ~/.claude/cook/templates/research-project/FEATURES.md
</output>
", subagent_type="cook-project-researcher", model="{researcher_model}", description="Features research")
...
Use template: ~/.claude/cook/templates/research-project/ARCHITECTURE.md
</output>
", subagent_type="cook-project-researcher", model="{researcher_model}", description="Architecture research")
...
Use template: ~/.claude/cook/templates/research-project/PITFALLS.md
</output>
", subagent_type="cook-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
Use template: ~/.claude/cook/templates/research-project/SUMMARY.md
Commit after writing.
</output>
", subagent_type="cook-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```

Display research complete banner and key findings:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 COOK ► RESEARCH COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Spawn cook-roadmapper agent with context:
...
", subagent_type="cook-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="cook-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
`/cook:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/cook:plan-phase [N]` — skip discussion, plan directly
...
- [ ] cook-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/cook:discuss-phase [N]`
