...
- Example: `/cook:remove-phase 17` → phase = 17
- Example: `/cook:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /cook:remove-phase <phase-number>
Example: /cook:remove-phase 17
```
...
To abandon current work, use /cook:pause-work instead.
```
...
Would you like to:
- `/cook:progress` — see updated roadmap status
