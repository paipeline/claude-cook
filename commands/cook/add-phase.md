...
- Example: `/cook:add-phase Add authentication` → description = "Add authentication"
- Example: `/cook:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /cook:add-phase <description>
Example: /cook:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /cook:plan-phase {N} to break down)
...
**Also available:**
- `/cook:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /cook:insert-phase)
- Don't create plans yet (that's /cook:plan-phase)
