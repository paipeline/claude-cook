...
│   └── cook/           # COOK-specific commands
├── cook/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/cook/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `cook/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `cook/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/cook/workflows/{name}.md`

**New Reference Document:**
- Implementation: `cook/references/{name}.md`
