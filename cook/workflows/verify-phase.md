...
<required_reading>
@~/.claude/cook/references/verification-patterns.md
@~/.claude/cook/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the cook-verifier agent -->
</step>
...
See ~/.claude/cook/templates/verification-report.md for complete template.
</step>
