...
Exit skill and invoke SlashCommand("/cook:plan-phase [X+1]")
...
**Also available:**
- `/cook:discuss-phase [X+1]` — gather context first
- `/cook:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/cook:complete-milestone {version}")
