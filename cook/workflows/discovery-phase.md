...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /cook:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/cook/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/cook/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/cook/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/cook/templates/discovery.md
...
Use ~/.claude/cook/templates/discovery.md.
...
1. Discuss phase context (/cook:discuss-phase [current-phase])
2. Create phase plan (/cook:plan-phase [current-phase])
