...
2. Read `~/.claude/cook/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/cook:new-milestone` which includes requirements definition. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next step (/cook:new-milestone)
