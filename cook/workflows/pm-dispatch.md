...
Called by:
- `/cook:pm-start` after sync (dispatch wave 1)
- `/cook:pm-check` when WAVE_COMPLETE detected (dispatch next wave)
- `/cook:pm-dispatch` manual command
</purpose>
...
Next: Workers are running. Check progress with /cook:pm-check
```
